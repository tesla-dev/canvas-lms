  ...
  ApiRouteSet::V1.draw(self) do
    ...
    scope(controller: :discussion_topics_api) do
      %w(course group).each do |context|
        ...
        get "#{context.pluralize}/:#{context}_id/discussion_topics/:topic_id/strongmind_flattened_replies", action: :strongmind_flattened_replies, as: "#{context}_discussion_topic_strongmind_flattened_replies"
